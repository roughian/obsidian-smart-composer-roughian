...
function ConnectClaudePlanModalComponent({
  ...
  const connect = async () => {
    ...
    if (!riskAccepted) {
      new Notice('Accept the experimental Claude Plan risk before connecting.')
      return
    }
  ...
  return (
    <div>
      ...
      <label className="smtcmp-plan-risk-consent">
        <input
          type="checkbox"
        ...
        />
        <span>
          I understand that this unofficial Plan connection may stop working or
          put my Claude account at risk.
        </span>
      </label>
      ...
      <ObsidianSetting>
        <ObsidianButton
          ...
          disabled={isConnecting || !riskAccepted}
          cta
        />
        <ObsidianButton
          text="Cancel"
